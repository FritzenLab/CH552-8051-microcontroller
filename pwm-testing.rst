      ...
      000000                        500 	.ds 8
                                    501 	.area REG_BANK_1	(REL,OVR,DATA)
      000008                        502 	.ds 8
                                    503 ;--------------------------------------------------------
                                    504 ; internal ram data
                                    505 ;--------------------------------------------------------
                                    506 	.area DSEG    (DATA)
      000010                        507 _tick_10ms::
      000010                        508 	.ds 2
      000012                        509 _last_tick:
      000012                        510 	.ds 2
      000014                        511 _pwm_value:
      000014                        512 	.ds 1
                                    513 ;--------------------------------------------------------
      ...
      000004                        571 	.ds	7
      00000B 02 00 D5         [24]  572 	ljmp	_timer0_ISR
      ...
      00004F 80 CF            [24]  630 	sjmp	sdcc_atomic_compare_exchange_idata_impl
                                    ...
                                    644 ;	pwm-testing.c:4: volatile unsigned int tick_10ms = 0;
      0000AD E4               [12]  645 	clr	a
      0000AE F5 10            [12]  646 	mov	_tick_10ms,a
      0000B0 F5 11            [12]  647 	mov	(_tick_10ms + 1),a
                                    648 ;	pwm-testing.c:5: static unsigned int last_tick = 0;
      0000B2 F5 12            [12]  649 	mov	_last_tick,a
      0000B4 F5 13            [12]  650 	mov	(_last_tick + 1),a
                                    651 ;	pwm-testing.c:6: static uint8_t pwm_value = 0;
      0000B6 F5 14            [12]  652 	mov	_pwm_value,a
                                    653 ;	pwm-testing.c:7: static __bit going_up = 1;
                                    654 ;	assignBit
      0000B8 D2 00            [12]  655 	setb	_going_up
                                    656 	.area GSFINAL (CODE)
      0000BD 02 00 51         [24]  657 	ljmp	__sdcc_program_startup
                                    658 ;--------------------------------------------------------
                                    659 ; Home
                                    660 ;--------------------------------------------------------
                                    661 	.area HOME    (CODE)
                                    662 	.area HOME    (CODE)
      000051                        663 __sdcc_program_startup:
      000051 02 01 50         [24]  664 	ljmp	_main
                                    ...
                                    669 	.area CSEG    (CODE)
                                    670 ;------------------------------------------------------------
                                    671 ;Allocation info for local variables in function 'clock_init'
                                    672 ;------------------------------------------------------------
                                    673 ;	pwm-testing.c:14: void clock_init(void) {
                                    674 ;	-----------------------------------------
                                    675 ;	 function clock_init
                                    676 ;	-----------------------------------------
      0000C0                        677 _clock_init:
                           000007   678 	ar7 = 0x07
                           000006   679 	ar6 = 0x06
                           000005   680 	ar5 = 0x05
                           000004   681 	ar4 = 0x04
                           ...
                           000001   684 	ar1 = 0x01
                           000000   685 	ar0 = 0x00
                                    686 ;	pwm-testing.c:15: SAFE_MOD = 0x55;
      0000C0 75 A1 55         [24]  687 	mov	_SAFE_MOD,#0x55
                                    688 ;	pwm-testing.c:16: SAFE_MOD = 0xAA;
      0000C3 75 A1 AA         [24]  689 	mov	_SAFE_MOD,#0xaa
                                    690 ;	pwm-testing.c:17: CLOCK_CFG |= bOSC_EN_INT;
      0000C6 43 B9 80         [24]  691 	orl	_CLOCK_CFG,#0x80
                                    692 ;	pwm-testing.c:18: CLOCK_CFG = (CLOCK_CFG & ~MASK_SYS_CK_SEL) | 0x06;
      0000C9 74 F8            [12]  693 	mov	a,#0xf8
      0000CB 55 B9            [12]  694 	anl	a,_CLOCK_CFG
      0000CD 44 06            [12]  695 	orl	a,#0x06
      0000CF F5 B9            [12]  696 	mov	_CLOCK_CFG,a
                                    697 ;	pwm-testing.c:19: SAFE_MOD = 0x00;
      0000D1 75 A1 00         [24]  698 	mov	_SAFE_MOD,#0x00
                                    699 ;	pwm-testing.c:20: }
      0000D4 22               [24]  700 	ret
                                    701 ;------------------------------------------------------------
                                    702 ;Allocation info for local variables in function 'timer0_ISR'
                                    703 ;------------------------------------------------------------
                                    704 ;	pwm-testing.c:22: void timer0_ISR(void) __interrupt(1) __using(1) {
                                    705 ;	-----------------------------------------
                                    706 ;	 function timer0_ISR
                                    707 ;	-----------------------------------------
      0000D5                        708 _timer0_ISR:
                           00000F   709 	ar7 = 0x0f
                           00000E   710 	ar6 = 0x0e
                           00000D   711 	ar5 = 0x0d
                           00000C   712 	ar4 = 0x0c
                           ...
                           000009   715 	ar1 = 0x09
                           000008   716 	ar0 = 0x08
      0000D5 C0 E0            [24]  717 	push	acc
      0000D7 C0 D0            [24]  718 	push	psw
      0000D9 75 D0 08         [24]  719 	mov	psw,#0x08
                                    720 ;	pwm-testing.c:23: TF0 = 0;
                                    721 ;	assignBit
      0000DC C2 8D            [12]  722 	clr	_TF0
                                    723 ;	pwm-testing.c:24: TH0 = 0xB1;
      0000DE 75 8C B1         [24]  724 	mov	_TH0,#0xb1
                                    725 ;	pwm-testing.c:25: TL0 = 0xE0;
      0000E1 75 8A E0         [24]  726 	mov	_TL0,#0xe0
                                    727 ;	pwm-testing.c:26: tick_10ms++;
      0000E4 AE 10            [24]  728 	mov	r6,_tick_10ms
      0000E6 AF 11            [24]  729 	mov	r7,(_tick_10ms + 1)
      0000E8 74 01            [12]  730 	mov	a,#0x01
      0000EA 2E               [12]  731 	add	a, r6
      0000EB F5 10            [12]  732 	mov	_tick_10ms,a
      0000ED E4               [12]  733 	clr	a
      0000EE 3F               [12]  734 	addc	a, r7
      0000EF F5 11            [12]  735 	mov	(_tick_10ms + 1),a
                                    736 ;	pwm-testing.c:27: }
      0000F1 D0 D0            [24]  737 	pop	psw
      0000F3 D0 E0            [24]  738 	pop	acc
      0000F5 32               [24]  739 	reti
                                    740 ;	eliminated unneeded push/pop dpl
                                    741 ;	eliminated unneeded push/pop dph
                                    742 ;	eliminated unneeded push/pop b
                                    743 ;------------------------------------------------------------
                                    744 ;Allocation info for local variables in function 'timer0_init'
                                    745 ;------------------------------------------------------------
                                    746 ;	pwm-testing.c:29: void timer0_init(void) {
                                    747 ;	-----------------------------------------
                                    748 ;	 function timer0_init
                                    749 ;	-----------------------------------------
      0000F6                        750 _timer0_init:
                           000007   751 	ar7 = 0x07
                           000006   752 	ar6 = 0x06
                           000005   753 	ar5 = 0x05
                           000004   754 	ar4 = 0x04
                           ...
                           000001   757 	ar1 = 0x01
                           000000   758 	ar0 = 0x00
                                    759 ;	pwm-testing.c:30: T2MOD &= ~bTMR_CLK;
      0000F6 53 C9 7F         [24]  760 	anl	_T2MOD,#0x7f
                                    761 ;	pwm-testing.c:31: T2MOD &= ~bT0_CLK;
      0000F9 53 C9 EF         [24]  762 	anl	_T2MOD,#0xef
                                    763 ;	pwm-testing.c:32: TMOD &= ~0x03;
      0000FC 53 89 FC         [24]  764 	anl	_TMOD,#0xfc
                                    765 ;	pwm-testing.c:33: TMOD |=  0x01;
      0000FF 43 89 01         [24]  766 	orl	_TMOD,#0x01
                                    767 ;	pwm-testing.c:34: TH0 = 0xB1;
      000102 75 8C B1         [24]  768 	mov	_TH0,#0xb1
                                    769 ;	pwm-testing.c:35: TL0 = 0xE0;
      000105 75 8A E0         [24]  770 	mov	_TL0,#0xe0
                                    771 ;	pwm-testing.c:36: TF0 = 0;
                                    772 ;	assignBit
      000108 C2 8D            [12]  773 	clr	_TF0
                                    774 ;	pwm-testing.c:37: ET0 = 1;
                                    775 ;	assignBit
      00010A D2 A9            [12]  776 	setb	_ET0
                                    777 ;	pwm-testing.c:38: TR0 = 1;
                                    778 ;	assignBit
      00010C D2 8C            [12]  779 	setb	_TR0
                                    780 ;	pwm-testing.c:39: EA = 1;
                                    781 ;	assignBit
      00010E D2 AF            [12]  782 	setb	_EA
                                    783 ;	pwm-testing.c:40: }
      000110 22               [24]  784 	ret
                                    785 ;------------------------------------------------------------
                                    786 ;Allocation info for local variables in function 'blink_led'
                                    787 ;------------------------------------------------------------
                                    788 ;	pwm-testing.c:41: void blink_led(void) {
                                    789 ;	-----------------------------------------
                                    790 ;	 function blink_led
                                    791 ;	-----------------------------------------
      000111                        792 _blink_led:
                                    793 ;	pwm-testing.c:42: if(tick_10ms % 50 < 25){
      000111 74 32            [12]  794 	mov	a,#0x32
      000113 C0 E0            [24]  795 	push	acc
      000115 E4               [12]  796 	clr	a
      000116 C0 E0            [24]  797 	push	acc
      000118 85 10 82         [24]  798 	mov	dpl, _tick_10ms
      00011B 85 11 83         [24]  799 	mov	dph, (_tick_10ms + 1)
      00011E 12 07 AA         [24]  800 	lcall	__moduint
      000121 AE 82            [24]  801 	mov	r6, dpl
      000123 AF 83            [24]  802 	mov	r7, dph
      000125 15 81            [12]  803 	dec	sp
      000127 15 81            [12]  804 	dec	sp
      000129 C3               [12]  805 	clr	c
      00012A EE               [12]  806 	mov	a,r6
      00012B 94 19            [12]  807 	subb	a,#0x19
      00012D EF               [12]  808 	mov	a,r7
      00012E 94 00            [12]  809 	subb	a,#0x00
      000130 50 04            [24]  810 	jnc	00102$
                                    811 ;	pwm-testing.c:43: P3 |= (1 << 0);  // LED ON
      000132 43 B0 01         [24]  812 	orl	_P3,#0x01
      000135 22               [24]  813 	ret
      000136                        814 00102$:
                                    815 ;	pwm-testing.c:45: P3 &= ~(1 << 0); // LED OFF
      000136 53 B0 FE         [24]  816 	anl	_P3,#0xfe
                                    817 ;	pwm-testing.c:47: }
      000139 22               [24]  818 	ret
                                    819 ;------------------------------------------------------------
                                    820 ;Allocation info for local variables in function 'pwm_init'
                                    821 ;------------------------------------------------------------
                                    822 ;	pwm-testing.c:48: void pwm_init(void) {
                                    823 ;	-----------------------------------------
                                    824 ;	 function pwm_init
                                    825 ;	-----------------------------------------
      00013A                        826 _pwm_init:
                                    827 ;	pwm-testing.c:51: PIN_FUNC &= ~bPWM1_PIN_X;
      00013A 53 C6 FB         [24]  828 	anl	_PIN_FUNC,#0xfb
                                    829 ;	pwm-testing.c:53: SPI0_CTRL &= ~bS0_MOSI_OE;  // make sure MOSI output is disabled
      00013D 53 FA BF         [24]  830 	anl	_SPI0_CTRL,#0xbf
                                    831 ;	pwm-testing.c:56: P1_MOD_OC &= ~(1 << 5);
      ...
      00014C 75 9D 04         [24]  840 	mov	_PWM_CTRL,#0x04
                                    841 ;	pwm-testing.c:69: }
      00014F 22               [24]  842 	ret
                                    843 ;------------------------------------------------------------
                                    844 ;Allocation info for local variables in function 'main'
                                    845 ;------------------------------------------------------------
                                    846 ;t             Allocated to registers r6 r7 
                                    847 ;------------------------------------------------------------
                                    848 ;	pwm-testing.c:71: void main(void) {
                                    849 ;	-----------------------------------------
                                    850 ;	 function main
                                    851 ;	-----------------------------------------
      000150                        852 _main:
                                    853 ;	pwm-testing.c:72: clock_init();
      000150 12 00 C0         [24]  854 	lcall	_clock_init
                                    855 ;	pwm-testing.c:73: timer0_init();
      000153 12 00 F6         [24]  856 	lcall	_timer0_init
                                    857 ;	pwm-testing.c:74: pwm_init();
      000156 12 01 3A         [24]  858 	lcall	_pwm_init
                                    859 ;	pwm-testing.c:78: P3_MOD_OC &= ~0x01;   // not open-drain
      000159 53 96 FE         [24]  860 	anl	_P3_MOD_OC,#0xfe
                                    861 ;	pwm-testing.c:79: P3_DIR_PU |= 0x01;    // output, with pull-up
      00015C 43 97 01         [24]  862 	orl	_P3_DIR_PU,#0x01
                                    863 ;	pwm-testing.c:81: while (1) {
      00015F                        864 00107$:
                                    865 ;	pwm-testing.c:83: EA = 0;
                                    866 ;	assignBit
      00015F C2 AF            [12]  867 	clr	_EA
                                    868 ;	pwm-testing.c:84: t = tick_10ms;
      000161 AE 10            [24]  869 	mov	r6,_tick_10ms
      000163 AF 11            [24]  870 	mov	r7,(_tick_10ms + 1)
                                    871 ;	pwm-testing.c:85: EA = 1;
                                    872 ;	assignBit
      000165 D2 AF            [12]  873 	setb	_EA
                                    874 ;	pwm-testing.c:87: blink_led();
      000167 C0 07            [24]  875 	push	ar7
      000169 C0 06            [24]  876 	push	ar6
      00016B 12 01 11         [24]  877 	lcall	_blink_led
      00016E D0 06            [24]  878 	pop	ar6
      000170 D0 07            [24]  879 	pop	ar7
                                    880 ;	pwm-testing.c:90: if ((t - last_tick) >= 1) {
      000172 EE               [12]  881 	mov	a,r6
      000173 C3               [12]  882 	clr	c
      000174 95 12            [12]  883 	subb	a,_last_tick
      000176 FC               [12]  884 	mov	r4,a
      000177 EF               [12]  885 	mov	a,r7
      000178 95 13            [12]  886 	subb	a,(_last_tick + 1)
      00017A FD               [12]  887 	mov	r5,a
      00017B C3               [12]  888 	clr	c
      00017C EC               [12]  889 	mov	a,r4
      00017D 94 01            [12]  890 	subb	a,#0x01
      00017F ED               [12]  891 	mov	a,r5
      000180 94 00            [12]  892 	subb	a,#0x00
      000182 40 DB            [24]  893 	jc	00107$
