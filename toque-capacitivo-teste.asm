...
;	toque-capacitivo-teste.c:5: volatile unsigned int tick_10ms = 0;
	clr	a
	mov	_tick_10ms,a
	mov	(_tick_10ms + 1),a
;	toque-capacitivo-teste.c:6: volatile unsigned int debounceTimer = 0;
	mov	_debounceTimer,a
	mov	(_debounceTimer + 1),a
;	toque-capacitivo-teste.c:17: volatile uint8_t touch_baseline = 0;
	mov	_touch_baseline,a
;	toque-capacitivo-teste.c:7: volatile __bit button_irq = 0;
;	assignBit
	clr	_button_irq
;	toque-capacitivo-teste.c:8: volatile __bit debounce = 0;
;	assignBit
	clr	_debounce
;	toque-capacitivo-teste.c:9: volatile __bit ledON = 0;
;	assignBit
	clr	_ledON
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
;	toque-capacitivo-teste.c:19: void clock_init(void) {
;	-----------------------------------------
;	 function clock_init
;	-----------------------------------------
_clock_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	toque-capacitivo-teste.c:20: SAFE_MOD = 0x55;
	mov	_SAFE_MOD,#0x55
;	toque-capacitivo-teste.c:21: SAFE_MOD = 0xAA;
	mov	_SAFE_MOD,#0xaa
;	toque-capacitivo-teste.c:23: CLOCK_CFG = (CLOCK_CFG & ~MASK_SYS_CK_SEL) | 0x06;
	mov	a,#0xf8
	anl	a,_CLOCK_CFG
	orl	a,#0x06
	mov	_CLOCK_CFG,a
;	toque-capacitivo-teste.c:25: SAFE_MOD = 0x00;
	mov	_SAFE_MOD,#0x00
;	toque-capacitivo-teste.c:26: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'touchkey_init'
;------------------------------------------------------------
;sum           Allocated to registers r6 r7 
;i             Allocated to stack - _bp +1 +1 
;------------------------------------------------------------
;	toque-capacitivo-teste.c:28: void touchkey_init(void) {
;	-----------------------------------------
;	 function touchkey_init
;	-----------------------------------------
_touchkey_init:
	push	_bp
	mov	_bp,sp
