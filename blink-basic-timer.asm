...
;------------------------------------------------------------
;	blink-basic-timer.c:12: void clock_init(void) {
;	-----------------------------------------
;	 function clock_init
;	-----------------------------------------
_clock_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	blink-basic-timer.c:13: SAFE_MOD = 0x55;
	mov	_SAFE_MOD,#0x55
;	blink-basic-timer.c:14: SAFE_MOD = 0xAA;
	mov	_SAFE_MOD,#0xaa
;	blink-basic-timer.c:16: CLOCK_CFG = (CLOCK_CFG & ~MASK_SYS_CK_SEL) | 0x06;
	mov	a,#0xf8
	anl	a,_CLOCK_CFG
	orl	a,#0x06
	mov	_CLOCK_CFG,a
;	blink-basic-timer.c:18: SAFE_MOD = 0x00;
	mov	_SAFE_MOD,#0x00
;	blink-basic-timer.c:19: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'timer0_ISR'
;------------------------------------------------------------
;	blink-basic-timer.c:21: void timer0_ISR(void) __interrupt(INT_NO_TMR0) {
;	-----------------------------------------
;	 function timer0_ISR
;	-----------------------------------------
_timer0_ISR:
