...
;	adc-example.c:7: volatile unsigned int tick_10ms = 0;
	clr	a
	mov	_tick_10ms,a
	mov	(_tick_10ms + 1),a
;	adc-example.c:9: unsigned char led_state = 0;
	mov	_led_state,a
;	adc-example.c:10: unsigned int serialTime= 0;
	mov	_serialTime,a
	mov	(_serialTime + 1),a
;	adc-example.c:11: unsigned int counter= 0;
	mov	_counter,a
	mov	(_counter + 1),a
