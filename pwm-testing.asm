...
;	pwm-testing.c:4: volatile unsigned int tick_10ms = 0;
	clr	a
	mov	_tick_10ms,a
	mov	(_tick_10ms + 1),a
;	pwm-testing.c:5: static unsigned int last_tick = 0;
	mov	_last_tick,a
	mov	(_last_tick + 1),a
;	pwm-testing.c:6: static uint8_t pwm_value = 0;
	mov	_pwm_value,a
;	pwm-testing.c:7: static __bit going_up = 1;
;	assignBit
	setb	_going_up
	.area GSFINAL (CODE)
